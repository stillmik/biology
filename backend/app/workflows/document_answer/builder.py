...
from .nodes import (
    build_document_answer_model_input_node,
    choose_document_answer_route,
    generate_document_answer_node,
    interpret_document_question_node,
    load_direct_document_evidence_node,
    retrieve_hierarchical_document_evidence_node,
    validate_document_answer_citations_node,
)
...
def create_document_answer_graph():
    ...
    builder.add_node(
        "retrieve_hierarchical_evidence",
        retrieve_hierarchical_document_evidence_node,
    )
    ...
    builder.add_conditional_edges(
        ...
        choose_document_answer_route,
        {
            "direct": "load_direct_evidence",
            "hierarchical": "retrieve_hierarchical_evidence",
        },
    )
